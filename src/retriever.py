...
_SINGLE_QUERY_PROMPT = (
    "Extract medical keywords from this admission note for PubMed search.\n\n"
    "Priority order:\n"
    "1. RARE or UNCOMMON diagnoses and conditions first\n"
    "2. Unusual lab findings or atypical values\n"
    "3. Unexpected combinations of comorbidities\n"
    "4. Specific procedures related to rare presentations\n\n"
    "Rules:\n"
    "- Output ONLY comma-separated medical keywords.\n"
    "- NO common/obvious diagnoses (e.g., skip 'hypertension', 'diabetes' unless central to rare presentation).\n"
    "- Maximum 15 keywords.\n"
...
_MULTI_QUERY_PROMPT = (
    "You analyze what makes this patient's presentation UNIQUE compared to typical cases.\n"
    "Generate exactly {n} PubMed search queries based on the distinguishing features.\n\n"
    "Focus on:\n"
    "1. What makes this case UNUSUAL or RARE — findings that deviate from typical presentations.\n"
    "2. The combination of conditions that rarely co-occur — unexpected comorbidity patterns.\n"
    "3. Specific values, measurements, or findings that are clinically significant "
    "because they are extreme, unexpected, or rare (e.g., very high/low lab values, "
    "atypical age of onset, unusual drug reactions).\n\n"
    "Rules:\n"
    "- Do NOT generate generic queries about common conditions.\n"
    "- Each query must highlight something that distinguishes this patient from 'typical' cases.\n"
    "- Use specific numeric values where clinically significant.\n"
    "- Output exactly {n} numbered lines. No explanation.\n\n"
    "Admission note:\n{note}\n\n"
    "Uniqueness-focused queries:"
)
