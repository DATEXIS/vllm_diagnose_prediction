...
_SINGLE_QUERY_PROMPT = (
    "You are a medical expert. Given this admission note, write a single concise "
    "PubMed search query as a SHORT SENTENCE OR PHRASE — NOT as a Boolean query.\n\n"
    "Focus specifically on:\n"
    "- The RAREST or most UNUSUAL diagnosis implied by the note.\n"
    "- Unexpected combinations of findings that suggest a rare condition.\n"
    "- Atypical presentations of known diseases.\n\n"
    "Rules:\n"
    "- Write as natural medical language — NO AND/OR operators, NO parentheses.\n"
    "- Maximum 20 words.\n"
...
_MULTI_QUERY_PROMPT = (
    "You rewrite clinical admission notes into exactly {n} natural language queries "
    "for dense vector search in PubMed. Do NOT use Boolean operators.\n\n"
    "Generate exactly {n} queries in this order:\n"
    "1. The RAREST or most ATYPICAL diagnosis in this case — write as a clinical phrase "
    "describing the unusual presentation or rare condition.\n"
    "2. The primary diagnosis with its key clinical manifestations — "
    "as a natural medical phrase.\n"
    "3. The most clinically significant comorbidity interaction or secondary finding — "
    "as a natural medical phrase.\n\n"
    "Rules:\n"
    "- Write each query as natural medical language (like a case report title).\n"
    "- NO AND, OR, NOT operators. NO parentheses. NO quotation marks.\n"
