...
_SINGLE_QUERY_PROMPT = (
    "You are a medical expert specializing in rare and atypical diagnoses.\n"
    "Given this admission note, generate a PubMed search query that focuses on "
    "UNCOMMON, RARE, or ATYPICAL aspects of the presentation.\n\n"
    "Rules:\n"
    "- Prioritize unusual symptom combinations, rare conditions, and atypical presentations.\n"
    "- Include findings that distinguish this case from typical presentations.\n"
    "- Focus on secondary, rare, or unexpected diagnoses beyond the obvious ones.\n"
    "- Use specific medical terminology for rare conditions.\n"
    "- Return ONLY the search query — no explanation.\n\n"
    "Admission note:\n{note}\n\n"
    "Search query (rare/atypical focus):"
)
