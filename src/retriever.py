...
_SINGLE_QUERY_PROMPT = (
    "Summarize this admission note as a clinical case description for PubMed retrieval.\n\n"
    "Write 1-2 sentences that a physician would use to search for similar cases.\n"
    "Structure: [Patient context] with [primary finding] and [unusual/rare aspect].\n\n"
    "Rules:\n"
    "- Emphasize what is clinically UNUSUAL or RARE about this presentation.\n"
    "- Write as a natural medical sentence — NO Boolean operators.\n"
    "- Include the most specific diagnosis terms available.\n"
...
_MULTI_QUERY_PROMPT = (
    "You rewrite clinical admission notes into exactly {n} dense retrieval queries for ICD coding. \n"
    "The goal is to retrieve literature about DIAGNOSES THAT ARE EASY TO MISS — the rare, secondary, or atypical conditions in the long tail.\n"
    "Generate exactly {n} queries in this order:\n\n"
    "1. [RARE/ATYPICAL] — Focus ONLY on findings that suggest an UNCOMMON diagnosis:\n"
    "   - Unusual symptom combinations\n"
    "   - Atypical presentations of common diseases\n" 
    "   - Rare complications or secondary diagnoses\n"
    "   - Findings that don't fit a typical pattern\n"
    "   DO NOT put common/obvious diagnoses here.\n\n"
    "2. [PRIMARY] — The main diagnosis with specific manifestations, complications, and abnormal findings.\n\n"
    "3. [CONTEXT] — Comorbidities, procedures, medications, and chronic conditions that affect coding.\n\n"
    "RULES:\n"
    "- Use ONLY explicitly stated information from the note\n"
    "- NO Boolean operators (AND, OR, NOT)\n"
    "- NO parentheses, NO quotation marks, NO ICD codes\n"
    "- Write as natural medical phrases (like a case report title)\n"
    "- Each phrase: 15-30 words\n"
    "- Prioritize SPECIFIC findings over broad disease names\n"
    "- Include: symptoms, abnormal labs, complications, procedures, medications, negations (e.g., 'without fever')\n"
    "- Output exactly {n} numbered lines, no explanations\n\n"
    "Admission note:\n{note}\n\n"
    "Queries:"
)
